...
const RiskTitleCard = React.memo(function RiskTitleCard({
  title,
  description,
  onCommitTitle,
  onCommitDescription,
...
export default function RiskDetailPage() {
  ...
  const linkedEntities = React.useMemo<LinkedEntity[]>(() => {
    if (!risk?.linkedEntityType || !risk?.linkedEntityId) return []
    return [{ type: risk.linkedEntityType, id: risk.linkedEntityId }]
  }, [risk])
